...
val poppingCandy = Enemy(20, 60, 10, 20, "Popping candy", EnemyKind.NORMAL)
...
val Slime = Enemy(160, 52, 0, 60, "Slime", EnemyKind.ELITE)
val Naga = Enemy(110, 56, 40, 14, "Naga", EnemyKind.ELITE)
